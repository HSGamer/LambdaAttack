...
public class SessionListener119 extends SessionAdapter {
    private final AbstractBot owner;

    SessionListener119(AbstractBot owner) {
        this.owner = owner;
    }
    ...
    public void packetReceived(Session session, Packet packet) {
        if (packet instanceof ClientboundPlayerChatPacket) {
            ...
            String message = DefaultComponentSerializer.get().serialize(chatPacket.getSignedContent());
